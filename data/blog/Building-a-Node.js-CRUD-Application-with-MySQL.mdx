---
slug: 'Building-a-Node.js-CRUD-Application-with-MySQL'
title: 'Building a Node.js CRUD Application with MySQL'
...
- **GET** `/api/items`: Get all items
  ...
  ![read_all_data](read_all_data.png)

- **GET** `/api/items/{id}`: Get a single item
- ![alt](read_one_data.png)

- **POST** `/api/items`: Create a new item

  ![alt](item_created.png)
  ![alt](created_table.png)

- **PUT** `/api/items/{id}`: Update an item

  ![alt](item_updated.png)
  ![alt](updated_table.png)

- **DELETE** `/api/items/{id}`: Delete an item

  ![alt](item_deleted.png)
  ![alt](deleted_table.png)
