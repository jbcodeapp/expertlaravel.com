---
<<<<<<< HEAD:data/blog/building-a-nodejs-express-rest-api-for-image-upload.mdx
slug: 'building-a-nodejs-express-rest-api-for-image-upload'
=======
slug: 'Building-a-Node.js-Express-REST-API-for-Image-Upload'
>>>>>>> main:data/blog/Building-a-Node.js-Express-REST-API-for-Image-Upload.mdx
