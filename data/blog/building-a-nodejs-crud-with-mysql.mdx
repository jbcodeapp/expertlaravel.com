---
<<<<<<< HEAD:data/blog/building-a-nodejs-crud-with-mysql.mdx
slug: 'building-a-nodejs-crud-with-mysql'
title: 'Building a Nodejs CRUD Application with MySQL 01'
=======
slug: 'Building-a-Node.js-CRUD-Application-with-MySQL'
title: 'Building a Node.js CRUD Application with MySQL'
>>>>>>> main:data/blog/Building-a-Node.js-CRUD-Application-with-MySQL.mdx
